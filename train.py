...
# Adjust this path to the actual location of pyskl
#sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), 'D:\pyskl-main\pyskl-main\pyskl')))
import sys
sys.path.insert(0, 'D:\pyskl-main\pyskl-main\pyskl')
